    ...
    var body: some View {
        NavigationView {
            ...
            Button(action: {
                ...
                self.addPosting(self.msgdata.msgContent) // not uploading message - look into this and watch youtube video to fix
            }){
...
struct TextView: UIViewRepresentable {
  ...
  //      self.textSaving.msgContent = uiView.text
    }
...
struct TextPage: View {
   ...
   // init() {
  //      self.text = self.msgdata.msgContent as! String
    //TextPage.textview = TextPage.textview
  //  }
    var body: some View {
        NavigationView {
            ZStack {
